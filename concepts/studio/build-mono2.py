...
.end{min-height:86vh;display:flex;align-items:center;padding:clamp(50px,10vh,130px) 0}
...
<section class=end><div class=w>
  ...
  <p class=under>Found, quantified line by line, handed back inside one working
  day. A day is the unit we work in.</p>
